export default {
  ...
  models: {
    ...
    body: 'The model you pick defines cost, speed, and quality. Here are 12 strong starting points today.',
    lastUpdated: 'April 2026',
    note: 'Prices, limits, and availability change. Check the official sites for the latest.',
    filters: [
      { id: 'all', label: 'All' },
    ...
    items: [
      ...
      },
      {
        ...
        description: "Cursor's recent agentic model, built for fast multi-file edits.",
        context: 'Not published',
        strengths: ['Interactive coding', 'Multi-file editing', 'Low latency'],
        availableIn: ['Cursor'],
        sourceName: 'Cursor blog',
        sourceUrl: 'https://cursor.com/blog/composer-2',
        modalContent: {
          extendedDescription:
            "Built for Cursor's flow. The focus is fast agentic coding: editing, using tools, tracking the project, and answering without slowing the loop down.",
        },
      },
      {
        name: 'GPT-5.4',
      ...
      },
      {
        ...
        family: 'openai',
        costLabel: 'Affordable',
        pricing: '$0.75 / $4.50 per 1M tokens',
        description: 'Smaller GPT-5.4 variant, good for coding and lower-cost subagents.',
        context: '400K tokens',
        strengths: ['Subagents', 'Cost-performance', 'Fast coding'],
      ...
      },
      {
        ...
        pricing: '$0.20 / $1.25 per 1M tokens',
        description:
          'Smallest and cheapest GPT-5.4 family model, useful for simple work at volume.',
        context: '400K tokens',
        strengths: ['Classification', 'Data extraction', 'Simple subagents'],
      ...
      },
      {
        ...
        family: 'google',
        costLabel: 'Mid-range',
        pricing: '$2 / $12 up to 200K · $4 / $18 above',
        description: "Google's strongest model for reasoning, multimodal work, and agentic coding.",
        context: '1M tokens',
      ...
      },
      {
        ...
        description: 'Fast Gemini 3-series model with a strong mix of intelligence and price.',
        context: '1M tokens',
      ...
      },
      {
        ...
        description: "DeepSeek API's official thinking mode, cheap and built for agents.",
        context: '128K tokens',
        strengths: ['Cheap reasoning', 'Tool use', 'Open-weight'],
        availableIn: ['DeepSeek API', 'OpenCode'],
        sourceName: 'DeepSeek docs',
        sourceUrl: 'https://api-docs.deepseek.com/quick_start/pricing/',
        modalContent: {
          extendedDescription:
            'The API name is deepseek-reasoner. It maps to DeepSeek-V3.2 in thinking mode and replaces the older R1-based card.',
        },
      },
      {
        ...
        family: 'qwen',
        costLabel: 'Affordable',
        pricing: '$0.30 / $1.50 per 1M tokens up to 32K',
        description: 'Recent Qwen coding model built for agents and assisted development.',
        context: 'up to 256K tokens',
        strengths: ['Agentic coding', 'Tool use', 'Low cost'],
        ...
        modalContent: {
          extendedDescription:
            'A good coding alternative when you want something inexpensive outside the OpenAI, Claude, and Gemini families.',
        },
      },
      {
        ...
        family: 'qwen',
        costLabel: 'Most affordable',
        pricing: '$0.216 / $0.861 per 1M tokens up to 32K',
        description: 'Cheap coding specialist, good for simple tasks and volume.',
        context: 'up to 200K tokens',
        strengths: ['Low price', 'Code specialist', 'Open-weight'],
        availableIn: ['Alibaba Model Studio', 'OpenCode', 'Ollama'],
        sourceName: 'Alibaba Cloud docs',
        sourceUrl: 'https://www.alibabacloud.com/help/en/model-studio/model-pricing',
        modalContent: {
          extendedDescription:
            'This is the smaller Qwen3 Coder option. It fits automations, simple edits, and workflows where price matters more than maximum capability.',
        },
      },
    ],
  },
